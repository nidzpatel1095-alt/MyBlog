...
<div class="navbar">
    ...
    <div class="nav-icons">
        ...
        <?php } else { ?>
            ...
            <a href="http://localhost/blogging_site/index.php" title="Home">🏠</a>
            <a href="http://localhost/blogging_site/auth/login.php" class="text-link" title="Login">Login</a>
            <a href="http://localhost/blogging_site/auth/register.php" class="text-link" title="Register">Register</a>
